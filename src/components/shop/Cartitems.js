...
//                           <div className="w-20 h-20 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0">
//                             <img
//                               src={item.imageUrl || item.img || "/placeholder.svg?height=80&width=80"}
...
//                           </div>
//                           <div className="flex-1 min-w-0">
//                             <h3 className="font-semibold text-gray-800 truncate">{item.name || item.type}</h3>
//                             <p className="text-sm text-gray-500 mt-1">{item.type || item.name}</p>
//                             <button
//                               onClick={() => removeFromCart(item.id)}
//                               className="text-sm text-red-500 hover:text-red-700 mt-2 font-medium"
//                             >
